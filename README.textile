...
@curl -L https://github.com/capncodewash/oh-my-zsh/raw/master/tools/install.sh | sh@

h4. via `wget`

@wget --no-check-certificate https://github.com/capncodewash/oh-my-zsh/raw/master/tools/install.sh -O - | sh@

*The SpotSpecific repo*

Includes "SpotSpecific.theme":https://github.com/capncodewash/oh-my-zsh/raw/master/SpotSpecific_theme.png
@wget --no-check-certificate https://github.com/capncodewash/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
